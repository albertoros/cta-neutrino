...
realsrc=open('nu_src_ts_'+str(int(ttrans))+'s_'+irf+'_'+str(int(tobscta))+'s.dat', 'w')
lowrealsrc=open('nu_src_low_ts_'+str(int(ttrans))+'s_'+irf+'_'+str(int(tobscta))+'s.dat', 'w')
fakesrc=open('nu_src_fake_'+str(int(ttrans))+'s_'+irf+'_'+str(int(tobscta))+'s.dat', 'w')
...
for i in xrange(0, imax):
    ...
    if z < 4.:
        ...
        if tsigstart < tobs:
            ...
            sim['caldb']     = caldb
            sim['irf']       = irf
            sim['outevents'] = 'events_nu_'+str(ttrans)+'s_'+irf+'_'+str(i+1)+'.fits'
            sim['ra']        = ra
            sim['dec']       = dec
            sim['rad']       = 2.0
            ...
            like = ctools.ctlike()
            like['inobs']     = 'events_nu_'+str(ttrans)+'s_'+irf+'_'+str(i+1)+'.fits'
            like['caldb']     = caldb
            like['irf']       = irf
